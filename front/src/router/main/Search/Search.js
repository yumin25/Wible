    ...
    <>
      ...
      <Container sx={{ borderTop: 1, borderColor: "#E5E5E5", display: "flex" }}>
        <Box sx={{ borderRight: 1, borderColor: "#E5E5E5", paddingRight: 5 }}>
          <Category wines={wines} country={country} countryHandler={countryHandler} type={type} typeHandler={typeHandler} price={price} priceHandler={priceHandler} sweetness={sweetness} sweetnessHandler={sweetnessHandler} body={body} bodyHandler={bodyHandler} acidity={acidity} acidityHandler={acidityHandler} tanin={tanin} taninHandler={taninHandler}></Category>
        </Box>
